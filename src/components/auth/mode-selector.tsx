      ...
      <div className="max-w-2xl mx-auto p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            사용 목적에 맞는 모드를 선택하면 더 편리하게 생기부를 관리할 수 있습니다.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <ModeCard
            mode="일반"
            title="일반"
            description="자유롭게 폴더를 만들고 생기부를 관리하고 싶은 분들"
            features={["폴더 생성 및 관리", "자유로운 제목 설정", "중첩 폴더 지원", "파일 버전 관리"]}
          ...
          <ModeCard
            mode="학생"
            title="학생"
            description="학년별, 과목별로 체계적으로 생기부를 관리하고 싶은 학생분들"
            features={["학년별 자동 분류", "과목별 정리", "자동 폴더 구조", "버전 관리"]}
          ...
          <ModeCard
            ...
            features={["연도별 분류", "학년/과목별 정리", "학생별 개별 관리", "상세 분류 체계"]}
        ...
        <div className="text-center">
          <Button onClick={handleConfirm} disabled={!selectedMode} className="px-8 py-3">
            선택 완료
          </Button>
        </div>
      </div>
